        ...
        <section className="order-panel spot-order-entry">
          ...
          <div className="spot-order-columns">
            <div className="spot-side-form buy-form">
              ...
              <div className="spot-percent"><input type="range" min="0" max="100" step="1" value={buyPercent} onChange={e=>setBuyFromPercent(Number(e.target.value))}/><div><span>0%</span><span>25%</span><span>50%</span><span>75%</span><span>100%</span></div></div>
            ...
            <div className="spot-side-form sell-form">
              ...
              <div className="spot-percent"><input type="range" min="0" max="100" step="1" value={sellPercent} onChange={e=>setSellFromPercent(Number(e.target.value))}/><div><span>0%</span><span>25%</span><span>50%</span><span>75%</span><span>100%</span></div></div>
