  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .knowledge-modal{width:min(620px,100%);background:#10151c;border:1px solid #263b54;border-radius:14px;padding:24px 28px 18px;box-shadow:0 30px 100px rgba(0,0,0,.55);position:relative;overflow:hidden}
        .knowledge-close{position:absolute;right:14px;top:14px;background:none;border:0;color:#aeb9c8;cursor:pointer;padding:4px}.knowledge-close svg{width:21px;height:21px}.knowledge-modal-icon{width:50px;height:50px;border-radius:12px;background:#122b49;border:1px solid #2860a0;display:grid;place-items:center;color:#60a5fa;margin-bottom:12px}
        .knowledge-modal h3{font-size:28px;line-height:1.15;letter-spacing:-.8px;margin:0 0 5px;color:#f5f8fc}.knowledge-modal-subtitle{color:#aeb9c8;font-size:14px;margin:0 0 13px;line-height:1.4}.knowledge-steps{display:flex;flex-direction:column;gap:0;border-top:1px solid #202c3a}.knowledge-step{display:grid;grid-template-columns:38px 1fr;gap:7px;padding:11px 0;border-bottom:1px solid #202c3a}.knowledge-step>strong{color:#60a5fa;font-size:13px}.knowledge-step b{font-size:14px;line-height:1.25;color:#f5f8fc}.knowledge-step p{color:#aeb9c8;line-height:1.32;margin:2px 0 0;font-size:12.5px}.knowledge-got-it{width:100%;height:44px;border:0;border-radius:8px;background:#2563eb;color:#fff;font-size:14px;font-weight:700;cursor:pointer;margin-top:12px}
        ...
        @media(max-width:900px){.knowledge-section{padding:85px 20px}.knowledge-heading h2{font-size:40px}.knowledge-grid{grid-template-columns:1fr;max-width:560px;margin:auto}.knowledge-card-button{min-height:0}.knowledge-modal{width:min(580px,100%);padding:22px 24px 16px}}
        @media(max-width:520px){.knowledge-heading h2{font-size:32px;letter-spacing:-1px}.knowledge-heading p{font-size:15px}.knowledge-card-button{padding:26px 24px}.knowledge-icon-wrap{width:70px;height:70px;margin-bottom:23px}.knowledge-card h3{font-size:22px}.knowledge-card p{font-size:15px}.knowledge-modal-backdrop{padding:10px}.knowledge-modal{padding:20px 18px 14px;border-radius:12px}.knowledge-modal-icon{width:46px;height:46px}.knowledge-modal h3{font-size:23px}.knowledge-modal-subtitle{font-size:13px;margin-bottom:10px}.knowledge-step{grid-template-columns:32px 1fr;padding:9px 0}.knowledge-step b{font-size:13px}.knowledge-step p{font-size:11.5px;line-height:1.28}.knowledge-got-it{height:42px;margin-top:10px}}
      `}</style>
    </>
  );
}
