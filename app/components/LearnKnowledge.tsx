    ...
    <>
      ...
      <style jsx global>{`
        *{box-sizing:border-box}
        .knowledge-section{width:100%;max-width:1160px;margin:0 auto;padding:54px 20px 60px;position:relative}
        ...
        @media(max-width:900px){.knowledge-section{padding:46px 16px 52px}.knowledge-heading h2{font-size:38px}.knowledge-grid{grid-template-columns:1fr;max-width:520px;margin:auto}.knowledge-card{height:250px}.knowledge-card-button{padding:17px 19px}.knowledge-modal{width:min(540px,calc(100vw - 20px));padding:16px 18px 12px}}
        @media(max-width:520px){.knowledge-heading h2{font-size:31px;letter-spacing:-1px}.knowledge-heading p{font-size:14px}.knowledge-card{height:238px}.knowledge-card-button{padding:16px 17px}.knowledge-icon-wrap{width:52px;height:52px;margin-bottom:11px}.knowledge-card h3{font-size:19px}.knowledge-card p{font-size:13px}.knowledge-modal-backdrop{padding:8px}.knowledge-modal{width:calc(100vw - 16px);max-height:calc(100vh - 16px);padding:14px 14px 10px;border-radius:11px}.knowledge-modal-icon{width:40px;height:40px}.knowledge-modal h3{font-size:21px}.knowledge-modal-subtitle{font-size:11.5px;margin-bottom:7px}.knowledge-step{grid-template-columns:27px 1fr;padding:6px 0}.knowledge-step b{font-size:11.5px}.knowledge-step p{font-size:10px;line-height:1.2}.knowledge-got-it{height:36px;margin-top:7px;font-size:12.5px}}
      `}</style>
    </>
  );
}
