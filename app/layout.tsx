          ...
          dangerouslySetInnerHTML={{
            __html: `(() => {
              const enhanceDownloads = () => {
                ...
                play.href = 'https://play.google.com/store/apps/';
                play.target = '_blank';
                play.rel = 'noopener noreferrer';
                play.setAttribute('aria-label', 'Open Google Play Store');
                ...
                apk.href = '/orbitex.apk';
                apk.setAttribute('download', 'ORBITEX.apk');
                apk.setAttribute('aria-label', 'Download ORBITEX APK');
