    ...
    <main className="member-dashboard">
      ...
      <div className="member-main">
        ...
        <section className="quick-actions" aria-label="Account actions">
          <Link href="/wallet" className="quick-action"><ArrowDown aria-hidden="true" /><b>Add funds</b></Link>
          <Link href="/wallet" className="quick-action"><ArrowUp aria-hidden="true" /><b>Send</b></Link>
          <Link href="/wallet" className="quick-action"><ArrowLeftRight aria-hidden="true" /><b>Transfer</b></Link>
          <Link href="/trade" className="quick-action"><BarChart3 aria-hidden="true" /><b>Trade</b></Link>
        </section>
