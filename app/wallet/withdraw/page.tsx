  ...
  return <main className="wallet-page">
    ...
    <div className="wallet-content">
      ...
      <section className="withdraw-layout">
        <div className={`wallet-panel withdraw-assets ${mobileStep === "details" ? "mobile-hidden" : ""}`}><div className="panel-top"><div><span className="wallet-kicker">SELECT ASSET</span><h2>Choose a withdrawal asset</h2></div><span className="asset-count">20 supported assets</span></div>
