...
export default function WalletPage() {
  ...
  useEffect(() => {
    const readTab = () => {
      ...
      setTab(value === "spot" || value === "futures" ? value : "overview");
    };
    readTab();
