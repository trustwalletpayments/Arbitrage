...
const DEMO_ADDRESSES: Record<string, string> = {
  bsc: "0xORBITEX-DEMO-BEP20-ADDRESS", eth: "0xORBITEX-DEMO-ERC20-ADDRESS", tron: "TORBITEXDEMO-TRC20-ADDRESS", aptos: "0xORBITEX-DEMO-APTOS-ADDRESS", solana: "ORBITEX-DEMO-SOLANA-ADDRESS", arbitrum: "0xORBITEX-DEMO-ARBITRUM-ADDRESS", ton: "EQORBITEXDEMO-TON-ADDRESS", optimism: "0xORBITEX-DEMO-OPTIMISM-ADDRESS", near: "orbitex-demo.near", polygon: "0xORBITEX-DEMO-POLYGON-ADDRESS", avalanche: "0xORBITEX-DEMO-AVAX-ADDRESS", sui: "0xORBITEX-DEMO-SUI-ADDRESS", base: "0xORBITEX-DEMO-BASE-ADDRESS", bitcoin: "bc1qorbitexdemobitcoinaddress", linea: "0xORBITEX-DEMO-LINEA-ADDRESS", xrp: "rORBITEXDemoXrpAddress", cardano: "addr1orbitexdemocardanoaddress", dogecoin: "DORBITEXDemoDogecoinAddress", polkadot: "1ORBITEXDemoPolkadotAddress", litecoin: "ltc1orbitexdemolitecoinaddress", bitcoincash: "bitcoincash:qorbitexdemoaddress", cosmos: "cosmos1orbitexdemoaddress", stellar: "GORBITEXDEMOSTELLARADDRESS",
};
