    ...
    <main className={`profile-page ${theme === "light" ? "theme-light" : ""} ${theme === "system" ? "theme-system" : ""}`}>
      ...
      <div className="profile-layout">
        ...
        <section className="profile-content">
          ...
          <section className="account-overview"><div><span className="card-kicker">ACCOUNT OVERVIEW</span><h2>Welcome back, {displayName}</h2><p>Your account is ready. Manage your details and preferences from one place.</p></div><div className="overview-stats"><div><strong>0</strong><span>Total trades</span></div><div><strong>0.00</strong><span>Account balance</span></div><div><strong>0</strong><span>Referrals</span></div></div></section>
